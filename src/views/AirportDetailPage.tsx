...
import { ExternalLink, CheckCircle2, XCircle, AlertCircle, HelpCircle, ArrowLeft } from 'lucide-react';
...
export default function AirportDetailPage({ slug }: AirportDetailPageProps) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
      {/* Back Button */}
      <Link href="/airports" className="inline-flex items-center gap-2 text-xs text-tan/70 hover:text-cream transition-colors">
